...
secedit /configure /db hisecdc_10.sdb /areas SECURITYPOLICY USER_RIGHTS REGKEYS /cfg hisecdc_10_sa.inf /overwrite /quiet
...
auditpol /clear /y
auditpol /restore /file:C:\secpol_10_nodc.csv
